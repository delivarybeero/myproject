...
<button type ="button"  class="remove" onclick="document.getElementById('checkoutForm').style.display='block';"><h2>اتمام الطلب</h2></button>
</div>
...
<div id="checkoutForm" style="display:none;">
    <form action="complete_order.php" method="post">
        ...
        <button type="submit" class="remove">تأكيد الطلب</button>
    </form>
</div>
